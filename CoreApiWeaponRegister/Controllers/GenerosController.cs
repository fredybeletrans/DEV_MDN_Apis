...
namespace CoreApiWeaponRegister.Controllers
{
    ...
    public class GenerosController : ControllerBase
    {
        ...
        private IGeneroRepository _userService;
        private IMapper _mapper;
        private readonly AppSettings _appSettings;

        public GenerosController(IGeneroRepository userService, IMapper mapper, IOptions<AppSettings> appSettings)
        {
            //ctx = _context;
        ...
        public IActionResult GetAll()
        {
            try
            {
                var generos = _userService.ObtenerGeneros();
                //_logger.LogInfo($"Returned all owners from database.");

                var estadosResult = _mapper.Map<IEnumerable<Generos_pw>>(generos);
