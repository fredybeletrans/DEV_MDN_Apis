...
{
    public class EstadosTablaRepository : GenericRepository<EstadosTabla_pw>, IEstadosTablaRepository
    {
        ...
        public EstadosTablaRepository(DataContext context, IConfiguration config, IMapper mapper)
            : base(context)
        {
            _config = config;
            _context = context;
        ...
        public IEnumerable<EstadosTabla_pw> ObtenerEstadosxTabla()
        {
            return FindAll()
